...
$sql = "INSERT INTO people (first_name, last_name, email, address, type, phone, front, back) VALUES ('$firstname', '$lastname', '$email', '$firstname', '$address', '$type', '$phone', '$front', '$back')";
